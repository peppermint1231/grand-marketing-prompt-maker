...
.result-card{
  position:sticky; top:20px; background:#ffffff; border:1px solid rgba(220,231,243,.96); border-radius:26px;
  padding:24px; box-shadow:0 18px 50px rgba(19,52,91,.08);
}
...
.copybox{border-radius:18px; border:1px dashed #c8d8ea; background:#fbfdff; padding:16px; max-height:520px; overflow:auto; white-space:pre-wrap; color:#172033; font-size:14px; line-height:1.68;}
.copybtn{
...
with right:
    ...
    st.markdown('<div class="result-sub">아래 내용을 복사해서 ChatGPT에 붙여넣으면 이미지 제작 요청문으로 바로 사용할 수 있습니다.</div>', unsafe_allow_html=True)
